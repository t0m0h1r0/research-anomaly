...
\begin{table}[tb]
  ...
  \begin{tabular}{llrrl}
    ...
    AE-5 & per-frame CNN + GRU hidden 24 & 9k--30k & 35--117 KB & original-hypothesis test \\
    \bottomrule
  \end{tabular}
  }
\end{table}
...
AE-5 は feature-family bucket map の reshape と decoder head が未凍結である。
実装候補に昇格する場合は、表 \ref{tab:model-details} と同じ
TensorFlow/Keras 形式 summary を追加し、shape と parameter count を固定してから
比較する。
