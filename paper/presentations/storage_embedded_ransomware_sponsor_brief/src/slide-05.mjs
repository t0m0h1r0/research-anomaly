...
export async function slide05(presentation, ctx) {
  ...
  title(ctx, slide, "ブロックストレージ内MLでは、重みより周辺状態とスケジュールが効く");
  ...
  panel(ctx, slide, {
    ...
    fill: C.white,
    stroke: C.line,
    title: "per-volume detector-data target",
    accent: C.amber,
  });
  const budgetRows = [
  ...
  pill(ctx, slide, { text: "V ~= 2000\n多数volumeを同じ10秒cadenceで守る", x: 632, y: 422, w: 170, h: 118, fill: C.blueSoft, stroke: C.blue, color: C.blue });
  pill(ctx, slide, { text: "Q slots\n同時推論slot数で一時scratchが増える", x: 822, y: 422, w: 170, h: 118, fill: C.purpleSoft, stroke: C.purple, color: C.purple });
  pill(ctx, slide, { text: "CPU window\n10秒内に全volumeを採点できるか", x: 1012, y: 422, w: 170, h: 118, fill: C.greenSoft, stroke: C.green, color: C.green });
