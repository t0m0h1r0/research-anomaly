...
\begin{table}[tb]
  ...
  \begin{tabularx}{\linewidth}{lYY}
    ...
    device-fit claim &
    MNN 変換済み model、offline/MNN score parity、volume あたり peak model-owned
    memory、共有 weight と per-volume state の分解、volume 数 $V$ に対する
    aggregate memory と 10 秒あたり CPU 時間。 &
    非主張。500 KB は per-volume 制約条件。 \\
    \bottomrule
  \end{tabularx}
\end{table}
