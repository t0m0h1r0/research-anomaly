...
\begin{enumerate}
  ...
  \item model file、weight、tensor、workspace、I/O buffer、score history を含む
        volume あたりの model-owned peak memory を測定する。
  \item volume 数 $V$ を変え、共有可能な weight と、volume ごとに複製される
        buffer、state、threshold、normalization を分けて aggregate memory と
        10 秒あたり CPU 時間を測定する。
  \item volume あたり peak が 500 KB を超える場合、feature 数、系列長 $N$、hidden size、
