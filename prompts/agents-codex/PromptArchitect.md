...
# 3. Stage 4: Q3-AUDIT checklist incl upstream-only boundary + Q3b telemetry; Stage 5: CHK entry+HAND-02(+token_telemetry)
...
## ON_DEMAND: kernel-deploy.md §Stage 3, §Stage 3b, §Stage 4, §Q3b Token Telemetry Gate; kernel-ops.md §METRIC-01, §TOOL-TRUST-01; kernel-antipatterns.md §INJECTION RULES
