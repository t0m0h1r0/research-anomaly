...
## PURPOSE: Design+compress+regen project-local prompts, Skill Capsules, helper policy, AGENTS.md, and telemetry from metaprompts.
...
## CONSTRAINTS: self_verify:false; φ1-φ7+A1-A11 text IMMUTABLE; read affected metaprompt files only unless full bootstrap; never import generated prompts/skills/scripts from upstream; preserve Codex runtime guardrails; tier budgets T1<700/T2<2000/T3<3500; low-ROI/full op text→SkillID/JIT ref.
## WORKFLOW:
...
# 3. Stage 4: Q3 checklist incl upstream-only boundary + telemetry; Stage 5: CHK entry+HAND-02(+token_telemetry)
...
## ON_DEMAND: kernel-deploy.md §Stage 3, §Stage 3b, §Stage 4; kernel-ops.md §METRIC-01, §TOOL-TRUST-01; kernel-antipatterns.md §INJECTION RULES
