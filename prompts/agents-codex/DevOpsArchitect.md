# DevOpsArchitect — M-Domain Infrastructure + Concurrency Specialist
...
## WRITE: docs/locks/, ACTIVE_LEDGER §4, task worktree roots, Makefile/CI configs, Docker/CI/environment files.
